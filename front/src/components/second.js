...
class X19205 extends React.Component {
  constructor(props) {
      super(props);
      this.state = { 
        checked:false,
  ...
  render() {
    return (
        <div data-layer="4570a4d4-3bfb-4848-9a85-55433dba2e12" className="x19205">        
          ...
          <button onClick ={this.handleClick} data-layer="f649af37-2d5a-417d-aed4-d865458d2c82" className={this.state.button ? "buttonTrue":"buttonFalse"}> 동의</button>
        </div>
            ...
            <div className = "reasonCheck">
              <label data-layer="587a5770-0a0c-464a-aaee-44db66171a38" className="x0b70efc5"><input type = "checkbox" name ="check1" value ="카이스트 및 타대학 계절학기"/> 카이스트 및 타대학 계절학기 </label>
              ...
              <label data-layer="5260bcb9-cff4-48d4-9598-127283429602" className="x55be5dce"><input type = "checkbox" name ="check1" value ="카이스트 및 타대학 계절학기"/>기타/ 개인사유</label>
            </div>
          ...
          <div className="typeCheck">
            <label data-layer="5e28e596-394b-46fd-8873-7a082e8757a5" className="x3a9ec23e"><input type = "checkbox" name ="check2" value ="가상방 개설"/>가상방 개설</label>
            <label data-layer="15eab9ab-d015-4f70-adf3-17f03e74b7ad" className="x132519e2"><input type = "checkbox" name ="check2" value ="가상방 참여"/>가상방 참여</label>
          </div>
        ...
        <Link to="./third">
          <button data-layer="7b62ba74-1227-4e4b-9579-2e31774e8e22" className="xdd469231">다음단계</button>
        </Link>
