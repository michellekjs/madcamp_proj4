...
export default class X19201 extends Component {
  ...
  render() {
    ...
    return (
        ...
        <svg data-layer="ff571557-2263-4d8e-99d1-412269352c9e" preserveAspectRatio="none" viewBox="0 -1 713.6142578125 2" className="x1"><path d="M 0 0 L 713.6142578125 0"  /></svg>
